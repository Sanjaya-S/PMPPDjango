...
class Profile(models.Model):
    ...
    avatar = models.ImageField(default = 'default_image/person.jpg', upload_to = 'profile_image/', blank = True, null = True)
...
class OrderMenu (models.Model):
    ...
    cashier = models.ForeignKey (User,
        related_name = 'cashier_order_menu', blank = True, null = True, on_delete = models.SET_NULL)
...
class OrderMenuDetail (models.Model):
    ...
    menu_resto = models.ForeignKey (User,
        related_name = 'menu_order_order_menu_detail', blank = True, null = True, on_delete = models.SET_NULL)
